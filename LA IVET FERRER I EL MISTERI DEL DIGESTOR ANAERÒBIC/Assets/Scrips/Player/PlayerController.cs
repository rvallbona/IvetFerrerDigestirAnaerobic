...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 minYRange = new Vector2(-5, 5), scaleRange = new Vector2(0.2f, 1.0f);

    [SerializeField] private Animator animator;
    private bool isMoving;
    [SerializeField] private GameController_Puzzle1 gm;
    private void Start()
    {
        gm = GameObject.FindGameObjectWithTag("GameController").GetComponent<GameController_Puzzle1>();
    ...
    private void AnimationController()
    {
        ...
        animator.SetBool("usingCoat", gm.usingCoat);
    }
